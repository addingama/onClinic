...
class MenuViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    */
    ...
    @IBOutlet weak var imgUserRole: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        switch user.role {
        case "Doctor":
            imgUserRole.image = #imageLiteral(resourceName: "icon_doctor")
            break
        
        case "Patient":
            imgUserRole.image = #imageLiteral(resourceName: "icon_patient")
            break
            
        case "Nurse":
            imgUserRole.image = #imageLiteral(resourceName: "icon_nurse")
            break
